...
<body>
    ...
    <div class="flex flex-col min-h-screen items-center bg-gray-100">
        ...
        <h1 class="text-4xl font-bold text-green-700 p-5">Check Your Skills</h1>
        <div class="w-full max-w-md">
            <div class="relative">
                <form action="/search-quiz" method="get">
                    <input class="w-full px-4 py-3 text-gray-700 border border-gray-300 
                    rounded-2xl shadow" type="text" name="search" id="" placeholder="Search Quiz...">
        ...
        <div class="w-200">
            <h1 class="text-2xl text-green-700 text-center my-5">Top Categories</h1>
            <ul class="border border-gray-200">
                ...
                <li class="even:bg-gray-200 p-2 ">
                    <ul class="flex justify-between">
                        ...
                        <li class="w-30 flex">
                            <a href="/user-quiz-list/{{$category->id}}/{{$category->name}}" class=""><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000">
        ...
        <div class="w-200">
            <h1 class="text-2xl text-green-700 text-center my-10">Top Quiz</h1>
